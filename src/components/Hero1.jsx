...
function Hero1() {
 return (
   ...
   <div>
  <div className='home' class="bg-neutral-50 px-6 py-12 text-center md:px-12 lg:text-left">
    <div class="w-100 mx-auto sm:max-w-2xl md:max-w-3xl lg:max-w-5xl xl:max-w-7xl">
      <div class="grid items-center gap-12 lg:grid-cols-2">
        <div class="mt-12 lg:mt-0">
          <h1 class="mt-2 mb-16 text-5xl font-bold tracking-tight md:text-6xl xl:text-7xl">
          አልባሽ <br /><span class="text-primary">የቻለውን ለጋሽ።</span>
          </h1>
        ...
        <div class="mb-12 lg:mb-0">
          <img src={hero}class="w-full rounded-lg shadow-lg dark:shadow-black/20" alt="" />
        </div>
      </div>
    </div>
  </div>
